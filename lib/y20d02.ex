defmodule Year2020.Day02.Part1 do
  def parse(input) do
    input
    |> String.split("\n", trim: true)
...
defmodule Year2020.Day02.Part2 do
...
defmodule Mix.Tasks.Y20D02 do
  use Mix.Task

  def run(_) do
    {:ok, input} = File.read("inputs/y20d02.txt")

    IO.puts("---- Part 1 ----")
    parsed = Year2020.Day02.Part1.parse(input)
    part1 = Year2020.Day02.Part1.solve(parsed)
    IO.puts("Part 1: #{part1}")

    IO.puts("---- Part 2 ----")
    parsed = Year2020.Day02.Part1.parse(input)
    part2 = Year2020.Day02.Part2.solve(parsed)
