defmodule Year2020.Day02.Test do
  ...
  test "part 1 parse: returns correct" do
    ...
    actual = Year2020.Day02.Part1.parse(@example_part1)
  ...
  test "part 1: example should be correct" do
    ...
    expected = 1
    assert Year2020.Day02.Part1.solve(input) == expected
  end
  ...
  test "part 2: example should be correct" do
    ...
    expected = 2286
    assert Year2020.Day02.Part2.solve(input) == expected
  end
end
